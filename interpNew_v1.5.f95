...
IMPLICIT NONE
  ...
  REAL(KIND=8)::UINT(6),VINT(6),WINT(6),WORK(4*NLMAX)
  ...
  !$acc& PT)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(16) private(ND,ND2,AA,AINV,UINT,VINT,WINT,B,A,PP2,PB2,PHI,W,WORK)
  DO INOD=1,NODEID(-2)
