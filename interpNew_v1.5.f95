...
IMPLICIT NONE
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::AA(:,:,:),A(:,:,:)
  ...
  ALLOCATE(ND(0:NLMAX,NODEID(-2)),PHI(NLMAX,NODEID(-2)),A(MBA,MBA,NODEID(-2)))
  ...
  !$acc& PI,DT,UX,UY,UZ,LINKTAB,SKK,IVV,FB,AA,B,WORK,ND2,W,ND,PHI,A)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(4) private(UINT,&
  !$acc& VINT,WINT,PB2,PP2,PT,AINV)
  DO INOD=1,NODEID(-2)
