...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  REAL(KIND=8)::UXL1,UYL1,UZL1,UXL3,UYL3,UZL3
   ...
   ALLOCATE(B(MBA,NLMAX,NODEID(-1)),PHI(NLMAX,NODEID(-1)),AA(MBA,NLMAX,NODEID(-1)),W(NLMAX,NODEID(-1)),ND(0:NLMAX,NODEID(-1)))
  ...
  !$acc& UX,UY,UZ,UXC1,UYC1,UZC1,UXC3,UYC3,UZC3,GAMMA,GAMMA2,B,PHI,AA,W,ND)
  !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(8) private(A,PB2,PP2,PT,AINV)
  DO INOD=1,NODEID(-1) 
