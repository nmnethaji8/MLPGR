...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::PHI(:,:),AA(:,:,:),PT(:,:)
  ...
  REAL(KIND=8)::UXL1,UYL1,UZL1,UXL3,UYL3,UZL3
   ...
   ALLOCATE(ND(0:NLMAX,NODEID(-1)))
   ALLOCATE(PT(MBA,NODEID(-1)))
  ...
  !$acc& PHI,AA,ND,PT)
  !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(16) private(B,W,AINV,A,PP2,PB2)
  DO INOD=1,NODEID(-1) 
