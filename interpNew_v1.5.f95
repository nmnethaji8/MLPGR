...
IMPLICIT NONE
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::PT(:,:)
  ...
  ALLOCATE(PHI(NLMAX,NODEID(-2)))
  ALLOCATE(PT(MBA,NODEID(-2)))
  ...
  !$acc& W,PHI,PT)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(16) private(ND,ND2,AA,AINV,UINT,VINT,WINT,B,A,PP2,PB2)
  DO INOD=1,NODEID(-2)
