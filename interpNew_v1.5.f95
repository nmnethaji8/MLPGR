...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  !$acc& UX,UY,UZ,UXC1,UYC1,UZC1,UXC3,UYC3,UZC3,GAMMA,GAMMA2,NNN,PHII)
  !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(1) private(ILINK,&
  !$acc& ND,W,PHI,A,B,PB2,PP2,PT,AINV,AA)
  DO INOD=1,NODEID(-1)    
