...
IMPLICIT NONE
  ...
  !$acc& PI,DT,UX,UY,UZ,LINKTAB,SKK,IVV,FB,AA,B,WORK,ND2,W,ND,PHI,A,AINV,PP2)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(4) private(UINT,&
  !$acc& VINT,WINT,PB2,PT)
  DO INOD=1,NODEID(-2)
