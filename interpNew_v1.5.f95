...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::B(:,:,:),PHI(:,:),AA(:,:,:),W(:,:),PP2(:,:,:),A(:,:,:),AINV(:,:,:)
  REAL(KIND=8)::PT(MBA)
  REAL(KIND=8)::PB2(MBA)
  ...
  REAL(KIND=8)::UXL1,UYL1,UZL1,UXL3,UYL3,UZL3
   ...
   ALLOCATE(W(NLMAX,NODEID(-1)),ND(0:NLMAX,NODEID(-1)),PP2(MBA,MBA,NODEID(-1)),A(MBA,MBA,NODEID(-1)),AINV(MBA,MBA,NODEID(-1)))
  ...
  !$acc& UX,UY,UZ,UXC1,UYC1,UZC1,UXC3,UYC3,UZC3,GAMMA,GAMMA2,B,PHI,AA,W,ND,PP2,A,AINV)
