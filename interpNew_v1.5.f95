...
IMPLICIT NONE
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::PP2(:,:,:),PB2(:,:),PT(:,:)
  ...
  ALLOCATE(PHI(NLMAX,NODEID(-2)),PP2(MBA,MBA,NODEID(-2)))
  ...
  !$acc& W,PHI,PP2,PB2,PT)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(16) private(ND,ND2,AA,AINV,UINT,VINT,WINT,B,A)
  DO INOD=1,NODEID(-2)
   ...
   DO INTI=1,6
      ...
      IF(NN.LE.3)THEN
       ...
       CALL SHAPPARA_R_SHA(LNODE,MBA,NLMAX,A,B,NN,ND,W(:,INOD),&
