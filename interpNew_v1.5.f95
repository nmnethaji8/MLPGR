...
IMPLICIT NONE
  ...
  ALLOCATE(AA(MBA,NLMAX,NODEID(-2)),B(MBA,NLMAX,NODEID(-2)),WORK(4*NLMAX,NODEID(-2)),ND2(0:4*NLMAX,NODEID(-2)))
  ...
  !$acc& PI,DT,UX,UY,UZ,LINKTAB,SKK,IVV,FB,AA,B,WORK,ND2)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(4) private(UINT,&
  !$acc& VINT,WINT,ND,W,PHI,A,PB2,PP2,PT,AINV)
  DO INOD=1,NODEID(-2)
