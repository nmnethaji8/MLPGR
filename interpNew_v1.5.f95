...
IMPLICIT NONE
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::AA(:,:,:),A(:,:,:),AINV(:,:,:),PP2(:,:,:)
  ...
  ALLOCATE(UINT(6,NODEID(-2)),VINT(6,NODEID(-2)),WINT(6,NODEID(-2)))
  ...
  !$acc& PI,DT,UX,UY,UZ,LINKTAB,SKK,IVV,FB,AA,B,WORK,ND2,W,ND,PHI,A,AINV,PP2,UINT,VINT,WINT)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(4) private(PB2,PT)
  DO INOD=1,NODEID(-2)
