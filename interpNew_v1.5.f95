...
SUBROUTINE PRESSURE_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
   ...
   !$acc& R,R0,CC,COORX,COORY,COORZ,NLINK,LNODE,NLMAX,NODN,MBA,IDWEI,B)
   !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(4) private(ND,&
   !$acc& W,PHI,A,PB2,PP2,PT,AINV,AA)
   DO INOD=1,NODEID(-1)
