...
IMPLICIT NONE
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::WORK(:,:)
  ...
  ALLOCATE(PB2(MBA,NODEID(-2)),PT(MBA,NODEID(-2)))
  ...
  !$acc& W,PHI,A,PP2,PB2,PT)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(16) private(ND,ND2,AA,AINV,UINT,VINT,WINT)
  DO INOD=1,NODEID(-2)
   ...
   DO INTI=1,6
      ...
      DO I2=1,NN
         I=ND(I2)
         UINT(INTI)=UINT(INTI)+PHI(I2,INOD)*UX(I,2)
         VINT(INTI)=VINT(INTI)+PHI(I2,INOD)*UY(I,2)
         WINT(INTI)=WINT(INTI)+PHI(I2,INOD)*UZ(I,2)
       ENDDO
   ENDDO
