...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  REAL(KIND=8),MANAGED,ALLOCATABLE::PHI(:,:),AA(:,:,:),PP2(:,:,:),PT(:,:),PB2(:,:)
  ...
  REAL(KIND=8)::UXL1,UYL1,UZL1,UXL3,UYL3,UZL3
   ...
   ALLOCATE(PT(MBA,NODEID(-1)),PB2(MBA,NODEID(-1)))
  ...
  !$acc& PHI,AA,ND,PP2,PB2,PT)
  !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(16) private(B,W,AINV,A)
  DO INOD=1,NODEID(-1) 
   ...
   IF (NN.LE.0) THEN
    ...
    CALL SHAPPARA_R_SHA(LNODE,MBA,NLMAX,A,B,NN,ND(:,INOD),W,&
      ...
      CALL SHAPEFUN_PHI_SHA(MBA,NLMAX,NN,AINV,B,PT(:,INOD),AA(:,:,INOD),PHI(:,INOD),I,J,K)
