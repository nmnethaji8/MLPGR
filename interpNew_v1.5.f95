...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
  ...
  INTEGER(KIND=4)::I,J,K,I2,NI
  REAL(KIND=8)::W(NLMAX)
  REAL(KIND=8),MANAGED,ALLOCATABLE::B(:,:,:),PHI(:,:),AA(:,:,:)
  REAL(KIND=8)::A(MBA,MBA),AINV(MBA,MBA),PT(MBA)
  REAL(KIND=8)::PB2(MBA),PP2(MBA,MBA)
  ...
  !$acc& UX,UY,UZ,UXC1,UYC1,UZC1,UXC3,UYC3,UZC3,GAMMA,GAMMA2,B,NNN,PHI,AA)
  !$acc parallel loop gang num_gangs(NODEID(-1)) vector vector_length(8) private(ND,W,A,PB2,PP2,PT,AINV)
  DO INOD=1,NODEID(-1) 
   ...
   IF (NN.LE.0) THEN
    ...
    CALL SHAPPARA_R_SHA(LNODE,MBA,NLMAX,A,B(:,:,INOD),NN,ND,W,&
      COORX,COORY,COORZ,I,NI,J,K,PB2,PP2,WWI)
