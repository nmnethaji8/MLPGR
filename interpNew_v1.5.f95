...
SUBROUTINE VELOCITY_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
   ...
   CALL VELOCITY_SMOOTH_SHA_K<<<CEILING(REAL(NODEID(-1))/8),8>>>(KW,LNODE,NODN,NODEID,NWALLID,NLMAX,MBA,COORX,COORY,COORZ,R1,DDR,UXC1,UYC1,UZC1,UXC3,UYC3,UZC3)
...
SUBROUTINE PRESSURE_SMOOTH_SHA(LNODE,NODN,NODEID,NWALLID,&
   ...
   !$acc& R,R0,CC,COORX,COORY,COORZ,NLINK,LNODE,NLMAX,NODN,MBA,IDWEI,B,AA,PHI,A,AINV,PP2,W,ND)
   ...
   DO INOD=1,NODEID(-1)
      ...
      IF((NWALLID(INOD,2).EQ.-10).OR.(NWALLID(INOD,2).EQ.-11).OR.(NODEID(INOD).EQ.4))CYCLE  
      
      WRITE(9,*),PHI(1:NNN(INOD),INOD)
   ENDDO
