...
IMPLICIT NONE
  ...
  ALLOCATE(AA(MBA,NLMAX,NODEID(-2)))
  ...
  !$acc& PI,DT,UX,UY,UZ,LINKTAB,SKK,IVV,FB,AA)
  !$acc parallel loop gang num_gangs(NODEID(-2)) vector vector_length(2) private(UINT,&
  !$acc& VINT,WINT,ND,W,PHI,A,B,PB2,PP2,PT,AINV,ND2,WORK)
  DO INOD=1,NODEID(-2)
   ...
   DO INTI=1,6
      ...
      IF(MBA.EQ.4)THEN
       ...
       CALL SHAPEFUN_PHI_SHA(MBA,NLMAX,NN,AINV,B,PT,AA(:,:,INOD),PHI,I,J,K)
