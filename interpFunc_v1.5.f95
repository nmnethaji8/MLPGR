...
SUBROUTINE MLPG_GET_ETA(FSDOM, NFS, XFS, YFS, ZFS, NOT, XOT, YOT, ZOT, ERR, DDL, NLMAX, PRINTERRMSG)
   ...
   ALLOCATE(B(4,NLMAX,NOT),NNN(NOT),PHII(NLMAX,NOT))
   ...
   !$acc& NFS,XFS,YFS,NLMAX,RIAV,PLANEID,ERR,PRINTERRMSG,B,NNN)
   !$acc parallel loop gang num_gangs(NOT) vector vector_length(4) private(ND,W,PHI,A,PB2,PP2,PT,AINV,AA)
   DO INOD=1,NOT
      ...
      CALL SHAPEFUN_PHI_SHA(4,NLMAX,NN,AINV,B(:,:,INOD),PT,AA,PHI,I,J,K)
